...
urlpatterns = [
    ...
    path('usr/<str:uname>/',views.usrprt),
    path('usag/<str:un>/<int:ag>/',views.usrage),
    path('emp/<str:eid>/<int:eage>/<str:ename>/',views.empdet),
    path('qw/',views.htm),
    path('yt/<str:name>/',views.ytname),
    path('et/<int:id>/<str:ename>/',views.emp),
    path('stud/',views.studentdetails),
    path('intJS/',views.internalJS),
